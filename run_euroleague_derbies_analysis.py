#!/usr/bin/env python
"""
Comprehensive Analysis for EuroLeague Games
- Anadolu Efes Istanbul vs Fenerbahce Beko Istanbul (Turkish Derby)
- Panathinaikos vs Olympiacos (Greek Derby)
...
def analyze_euroleague_match(
    home_team, away_team, home_data, away_data, market_data, venue, 
    date="2026-06-05", league="EuroLeague", player_props_data=None
):
    """Analyze a EuroLeague match with comprehensive betting analysis"""
    ...
    # 1H is roughly average of Q1 and full game pace
    ...
    league_avg_fg_pct = 0.465  # EuroLeague average FG%
    ...
    home_proj_fg_pct *= 1.02  # Home court
...
def run_anadolu_fenerbahce_analysis():
    """Run comprehensive analysis for Anadolu Efes vs Fenerbahce"""
    
    print("\n" + "=" * 80)
    print("TURKISH DERBY: ANADOLU EFES ISTANBUL vs FENERBAHCE BEKO ISTANBUL")
    print("EuroLeague - June 5, 2026")
    print("=" * 80 + "\n")
    
    # Anadolu Efes Istanbul (Home)
    home_data = {
        'ortg': 115.8,
        'drtg': 108.2,
        'baseline_net': 7.6,
    ...
    result = analyze_euroleague_match(
        home_team="Anadolu Efes Istanbul",
        away_team="Fenerbahce Beko Istanbul",
        home_data=home_data,
        away_data=away_data,
        market_data=market_data,
...
def run_panathinaikos_olympiacos_analysis():
    """Run comprehensive analysis for Panathinaikos vs Olympiacos"""
    
    print("\n" + "=" * 80)
    print("GREEK DERBY: PANATHINAIKOS vs OLYMPIACOS")
    print("EuroLeague - June 5, 2026")
    print("=" * 80 + "\n")
...
def main():
    """Run both EuroLeague derby analyses"""
    
    print("=" * 80)
    print("EUROLEAGUE DERBIES COMPREHENSIVE ANALYSIS")
    print("June 5, 2026")
    print("=" * 80)
    
    # Run Turkish Derby
    turkish_derby = run_anadolu_fenerbahce_analysis()
    
    # Run Greek Derby
    greek_derby = run_panathinaikos_olympiacos_analysis()
    ...
    # Save Turkish Derby
    with open(output_dir / "anadolu_efes_vs_fenerbahce_analysis.json", 'w') as f:
        json.dump(turkish_derby, f, indent=2)
    
    # Save Greek Derby
    with open(output_dir / "panathinaikos_vs_olympiacos_analysis.json", 'w') as f:
        json.dump(greek_derby, f, indent=2)
    ...
    print("=" * 80)
    print()
    print("Turkish Derby (Anadolu Efes vs Fenerbahce):")
    print(f"  Spread: {turkish_derby['recommendations']['spread']}")
    print(f"  Moneyline: {turkish_derby['recommendations']['moneyline']}")
    print(f"  Total: {turkish_derby['recommendations']['total']}")
    print(f"  1Q: {turkish_derby['recommendations']['q1_spread']}")
    print(f"  1H: {turkish_derby['recommendations']['h1_spread']}")
    print()
    print("Greek Derby (Panathinaikos vs Olympiacos):")
    print(f"  Spread: {greek_derby['recommendations']['spread']}")
    print(f"  Moneyline: {greek_derby['recommendations']['moneyline']}")
    print(f"  Total: {greek_derby['recommendations']['total']}")
    print(f"  1Q: {greek_derby['recommendations']['q1_spread']}")
    print(f"  1H: {greek_derby['recommendations']['h1_spread']}")
    print()
    print(f"Results saved to:")
    print(f"  - output/anadolu_efes_vs_fenerbahce_analysis.json")
    print(f"  - output/panathinaikos_vs_olympiacos_analysis.json")
    print()
    print("=" * 80)
