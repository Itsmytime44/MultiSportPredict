#!/usr/bin/env python
"""
Comprehensive Analysis for Greek Basket League Finals Game 3
- Olympiacos vs Panathinaikos

Focus: 1Q, 1H, FG, Spreads, Moneyline, Totals, and Player Props
Series tied 1-1, Game 3 at Peace and Friendship Stadium
"""
...
def analyze_basketball_match(
    ...
    date="2026-06-08", league="Greek Basket League Finals", player_props_data=None
):
    ...
    print(f"{league} - Game 3 - {date}")
    print(f"Venue: {venue}")
    print(f"Series: Tied 1-1")
    print("=" * 80)
    print()
    ...
    print()
    print(f"   {away_team} (without Cedi Osman):")
    ...
    print(f"      [WARNING] Cedi Osman OUT - Lower back discomfort")
    print()
    ...
    print(f"   [NOTE] Expect slow-paced defensive slugfest")
    print()
    ...
    print(f"   [NOTE] Home court advantage crucial in Finals")
    print()
    ...
    ctx = GameContext(
        game_id=f"{home_team.replace(' ', '_')}_vs_{away_team.replace(' ', '_')}_game3",
        date=date,
        league=league,
    ...
    print(f"   [NOTE] Olympiacos historically starts strong at home")
    ...
    print(f"   [NOTE] Olympiacos depth advantage shows in 2nd quarter")
    ...
    league_avg_fg_pct = 0.455  # Greek League average
    
    home_fg_offense_factor = home_data['ortg'] / 105.0
    home_fg_defense_factor = 105.0 / home_data['drtg']
    away_fg_offense_factor = away_data['ortg'] / 105.0
    away_fg_defense_factor = 105.0 / away_data['drtg']
    ...
    home_proj_fg_pct *= 1.02  # Home court boost
    ...
    print()
    print(f"   {away_team} (without Osman):")
    ...
    print(f"   [NOTE] Panathinaikos spacing suffers without Osman")
    print()
    ...
    print(f"   [NOTE] Olympiacos heavy favorite at home in must-win Game 3")
    print()
    ...
    print(f"   [NOTE] Game 2 ended at 126 points; expect defensive slugfest")
    print()
    ...
    # FINAL SUMMARY
    print("=" * 80)
    print("FINAL ANALYSIS SUMMARY - GREEK BASKET LEAGUE FINALS GAME 3")
    print("=" * 80)
    print()
    ...
    print()
    print("   === SAFE WAGER BETTING SLIP ===")
    print(f"   [1] 1Q: Olympiacos -0.5 (Safe/Moderate)")
    print(f"   [2] 1H: Olympiacos -2.5 (Safe)")
    print(f"   [3] FG: Olympiacos Moneyline (Very Safe)")
    print(f"   [4] FG: Under 164.5 Total Points (Safe)")
    print(f"   [5] PROP: Kendrick Nunn Over 17.5 Points (Safe/Moderate)")
    print(f"   [6] PROP: Nikola Milutinov Over 6.5 Rebounds (Safe)")
    print()
    ...
    results = {
        "game_info": {
            ...
            "date": date,
            "venue": venue,
            "series_status": "Tied 1-1",
            "game_number": 3
        },
        "team_metrics": {
            "home": home_data,
            "away": away_data,
            "key_absence": "Cedi Osman (Panathinaikos) - OUT (lower back discomfort)"
        },
        ...
        "safe_wager_slip": {
            "q1": "Olympiacos -0.5",
            "h1": "Olympiacos -2.5",
            "moneyline": "Olympiacos ML",
            "total": "Under 164.5",
            "prop1": "Kendrick Nunn Over 17.5 Points",
            "prop2": "Nikola Milutinov Over 6.5 Rebounds"
        },
...
def run_olympiacos_panathinaikos_game3_analysis():
    """Run comprehensive analysis for Olympiacos vs Panathinaikos Game 3"""
    
    print("\n" + "=" * 80)
    print("GREEK BASKET LEAGUE FINALS - GAME 3")
    print("Olympiacos vs Panathinaikos - Series Tied 1-1")
    print("June 8, 2026 - Peace and Friendship Stadium, Piraeus")
    print("=" * 80 + "\n")
    
    # Olympiacos (Home) - Full strength, experienced core
    home_data = {
        'ortg': 112.5,
        'drtg': 105.8,
        'baseline_net': 6.7,
        ...
        'back_to_back': False,
        'three_in_six': False,
        'split_edge': 8.5,  # Strong home court advantage
        'rotation_depth': 10,
        'injury_status': 'green',
    ...
    # Panathinaikos (Away) - Without Cedi Osman
    away_data = {
        'ortg': 102.5,  # Reduced without Osman's scoring
        'drtg': 108.2,  # Defense slightly worse without his versatility
        'baseline_net': -5.7,
        'recent_net': -4.5,
        'pace': 70.0,
        'rest_days': 2,
        'travel_km': 350,  # Athens to Piraeus
        'back_to_back': False,
        'three_in_six': False,
        'split_edge': -3.5,  # Poor road performance
        'rotation_depth': 8,  # Reduced depth without Osman
        'injury_status': 'red',  # Osman out
        'coach_stability': 'green',
        'motivation': 'green',
    }
    ...
    player_props = [
        ...
        # Panathinaikos
        {
            ...
            "prop_type": "Points",
            "prop_line": 17.5,
            "player_avg": 21.5,  # Increased usage without Osman
            "minutes_proj": 35.0,
            "usage_rate": 32.0,  # Spike in usage
            "game_pace": 71,
    ...
    result = analyze_basketball_match(
        ...
        date="2026-06-08",
        league="Greek Basket League Finals",
...
def main():
    """Run Olympiacos vs Panathinaikos Game 3 analysis"""
    
    print("=" * 80)
    print("GREEK BASKET LEAGUE FINALS - GAME 3 COMPREHENSIVE ANALYSIS")
    print("June 8, 2026")
    print("=" * 80)
    
    result = run_olympiacos_panathinaikos_game3_analysis()
    
    # Save results
    output_dir = Path("output")
    output_dir.mkdir(parents=True, exist_ok=True)
    
    with open(output_dir / "olympiacos_panathinaikos_game3_analysis.json", 'w') as f:
    ...
    print("=" * 80)
    print()
    print("Olympiacos vs Panathinaikos (Game 3 - Series tied 1-1):")
    ...
    print()
    print("  === SAFE WAGER BETTING SLIP ===")
    for key, value in result['safe_wager_slip'].items():
        print(f"  {key.replace('_', ' ').title()}: {value}")
    print()
    print(f"Results saved to: output/olympiacos_panathinaikos_game3_analysis.json")
    print()
    print("=" * 80)
