...
def analyze_basketball_match(
    ...
    date="2026-06-06", league="BBL (Germany)", player_props_data=None
):
...
def run_bamberg_berlin_analysis():
    """Run comprehensive analysis for Brose Bamberg vs Alba Berlin"""
    
    print("\n" + "=" * 80)
    print("BBL GERMANY: BROSE BAMBERG vs ALBA BERLIN")
    print("BBL (Germany) - June 6, 2026")
    print("=" * 80 + "\n")
...
def main():
    """Run Brose Bamberg vs Alba Berlin analysis"""
    ...
    result = run_bamberg_berlin_analysis()
    
    # Save results
    output_dir = Path("output")
    output_dir.mkdir(parents=True, exist_ok=True)
    
    with open(output_dir / "brose_bamberg_vs_alba_berlin_analysis.json", 'w') as f:
    ...
    print("=" * 80)
    print()
    print("Brose Bamberg vs Alba Berlin:")
    ...
    print()
    print(f"Results saved to: output/brose_bamberg_vs_alba_berlin_analysis.json")
    print()
    print("=" * 80)
