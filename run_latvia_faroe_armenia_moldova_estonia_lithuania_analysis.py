#!/usr/bin/env python
"""
Comprehensive Analysis for International Soccer Matches
...
def run_latvia_vs_faroe_islands():
    """Run analysis for Latvia vs Faroe Islands"""
    
    print("\n" + "=" * 80)
    print("INTERNATIONAL MATCH: LATVIA vs FAROE ISLANDS")
    print("International Friendly - June 9, 2026")
    print("=" * 80 + "\n")
    
    # Latvia (Home) - Moderate European national team
    home_data = {
        'xg_for': 1.35,
        'xg_against': 1.40,
        'shots': 11.0,
    ...
    # Faroe Islands (Away) - Lower-ranked but improving team
    away_data = {
        'xg_for': 1.10,
        'xg_against': 1.65,
        'shots': 9.5,
...
def run_armenia_vs_moldova():
    """Run analysis for Armenia vs Moldova"""
    
    print("\n" + "=" * 80)
    print("INTERNATIONAL MATCH: ARMENIA vs MOLDOVA")
    print("International Friendly - June 9, 2026")
    print("=" * 80 + "\n")
    
    # Armenia (Home) - Moderate European national team
    home_data = {
        'xg_for': 1.40,
        'xg_against': 1.45,
        'shots': 11.5,
    ...
    # Moldova (Away) - Defensive-minded team
    away_data = {
        'xg_for': 1.15,
        'xg_against': 1.50,
        'shots': 10.0,
...
def run_estonia_vs_lithuania():
    """Run analysis for Estonia vs Lithuania"""
    
    print("\n" + "=" * 80)
    print("INTERNATIONAL MATCH: ESTONIA vs LITHUANIA")
    print("International Friendly - June 9, 2026")
    print("=" * 80 + "\n")
    
    # Estonia (Home) - Moderate Baltic national team
    home_data = {
        'xg_for': 1.25,
        'xg_against': 1.50,
        'shots': 10.5,
    ...
    # Lithuania (Away) - Similar level Baltic rival
    away_data = {
        'xg_for': 1.30,
        'xg_against': 1.45,
        'shots': 11.0,
...
def main():
    """Run all three international soccer match analyses"""
    ...
    # Run Latvia vs Faroe Islands
    latvia_faroe_result = run_latvia_vs_faroe_islands()
    
    # Run Armenia vs Moldova
    armenia_moldova_result = run_armenia_vs_moldova()
    
    # Run Estonia vs Lithuania
    estonia_lithuania_result = run_estonia_vs_lithuania()
    
    # Save results
    output_dir = Path("output")
    output_dir.mkdir(parents=True, exist_ok=True)
    
    with open(output_dir / "latvia_vs_faroe_islands_analysis.json", 'w') as f:
        json.dump(latvia_faroe_result, f, indent=2)
    
    with open(output_dir / "armenia_vs_moldova_analysis.json", 'w') as f:
        json.dump(armenia_moldova_result, f, indent=2)
    
    with open(output_dir / "estonia_vs_lithuania_analysis.json", 'w') as f:
        json.dump(estonia_lithuania_result, f, indent=2)
    ...
    print("=" * 80)
    print()
    print("Latvia vs Faroe Islands:")
    print(f"  Projected Score: Latvia {latvia_faroe_result['projections']['home_expected_goals']:.1f} - Faroe Islands {latvia_faroe_result['projections']['away_expected_goals']:.1f}")
    print(f"  Outcome: {latvia_faroe_result['recommendations']['match_outcome']}")
    print(f"  Goals: {latvia_faroe_result['recommendations']['goals']}")
    print(f"  BTTS: {latvia_faroe_result['recommendations']['btts']}")
    print(f"  Corners: {latvia_faroe_result['recommendations']['corners']}")
    print()
    print("Armenia vs Moldova:")
    print(f"  Projected Score: Armenia {armenia_moldova_result['projections']['home_expected_goals']:.1f} - Moldova {armenia_moldova_result['projections']['away_expected_goals']:.1f}")
    print(f"  Outcome: {armenia_moldova_result['recommendations']['match_outcome']}")
    print(f"  Goals: {armenia_moldova_result['recommendations']['goals']}")
    print(f"  BTTS: {armenia_moldova_result['recommendations']['btts']}")
    print(f"  Corners: {armenia_moldova_result['recommendations']['corners']}")
    print()
    print("Estonia vs Lithuania:")
    print(f"  Projected Score: Estonia {estonia_lithuania_result['projections']['home_expected_goals']:.1f} - Lithuania {estonia_lithuania_result['projections']['away_expected_goals']:.1f}")
    print(f"  Outcome: {estonia_lithuania_result['recommendations']['match_outcome']}")
    print(f"  Goals: {estonia_lithuania_result['recommendations']['goals']}")
    print(f"  BTTS: {estonia_lithuania_result['recommendations']['btts']}")
    print(f"  Corners: {estonia_lithuania_result['recommendations']['corners']}")
    print()
    print(f"Results saved to:")
    print(f"  - output/latvia_vs_faroe_islands_analysis.json")
    print(f"  - output/armenia_vs_moldova_analysis.json")
    print(f"  - output/estonia_vs_lithuania_analysis.json")
    print()
    print("=" * 80)
