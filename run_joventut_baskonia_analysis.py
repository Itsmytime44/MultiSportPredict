#!/usr/bin/env python
"""
Comprehensive Analysis for Spanish ACB League Game
- Joventut Badalona vs Baskonia
...
def analyze_basketball_match(
    ...
    date="2026-06-05", league="ACB", player_props_data=None
):
...
def run_joventut_baskonia_analysis():
    """Run comprehensive analysis for Joventut Badalona vs Baskonia"""
    
    print("\n" + "=" * 80)
    print("SPANISH ACB: JOVENTUT BADALONA vs BASKONIA")
    print("ACB League - June 5, 2026")
    print("=" * 80 + "\n")
    
    # Joventut Badalona (Home)
    home_data = {
        'ortg': 112.8,
        'drtg': 109.5,
        'baseline_net': 3.3,
    ...
    result = analyze_basketball_match(
        home_team="Joventut Badalona",
        away_team="Baskonia",
        home_data=home_data,
        away_data=away_data,
        market_data=market_data,
        venue="Olimpic de Badalona, Barcelona",
        date="2026-06-05",
        league="ACB",
...
def main():
    """Run Joventut vs Baskonia analysis"""
    
    print("=" * 80)
    print("SPANISH ACB COMPREHENSIVE ANALYSIS")
    print("June 5, 2026")
    print("=" * 80)
    
    result = run_joventut_baskonia_analysis()
    
    # Save results
    output_dir = Path("output")
    output_dir.mkdir(parents=True, exist_ok=True)
    
    with open(output_dir / "joventut_baskonia_analysis.json", 'w') as f:
    ...
    print("=" * 80)
    print()
    print("Joventut Badalona vs Baskonia:")
    ...
    print()
    print(f"Results saved to: output/joventut_baskonia_analysis.json")
    print()
    print("=" * 80)
