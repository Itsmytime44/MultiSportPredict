#!/usr/bin/env python
"""
Comprehensive Analysis for NBA Game
...
def run_spurs_knicks_analysis():
    """Run comprehensive analysis for Spurs vs Knicks"""
    
    print("=" * 80)
    print("COMPREHENSIVE ANALYSIS: SAN ANTONIO SPURS vs NEW YORK KNICKS")
    print("NBA - June 3, 2026")
    print("=" * 80)
    print()
    
    # Define team data based on typical NBA metrics
    # San Antonio Spurs (Home)
    home_data = {
        'ortg': 112.5,        # Offensive Rating
        'drtg': 115.2,        # Defensive Rating
        'baseline_net': -2.7,  # Baseline net rating
        'recent_net': -1.5,    # Recent net rating (last 10 games)
        'pace': 99.5,          # Pace (possessions per 48 min)
        'rest_days': 2,
        'travel_km': 0,        # Home team, no travel
        'back_to_back': False,
        'three_in_six': False,
        'split_edge': 3.2,     # Home court advantage factor
    ...
    away_data = {
        'ortg': 114.8,        # Offensive Rating
        'drtg': 110.5,        # Defensive Rating
        'baseline_net': 4.3,   # Baseline net rating
        'recent_net': 5.2,     # Recent net rating (last 10 games)
        'pace': 97.2,          # Pace (possessions per 48 min)
        'rest_days': 1,
        'travel_km': 350,      # Travel from New York to San Antonio
        'back_to_back': False,
        'three_in_six': False,
        'split_edge': -1.8,    # Road performance factor
    ...
    # Market data
    market_data = {
        'open_line': -3.5,     # Knicks opened as 3.5 point favorites
        'current_line': -4.0,  # Current line moved to Knicks -4
        'spread': -4.0,        # Knicks favored by 4
        'total': 218.5,        # Over/Under total
    }
    ...
    # Define player props data for key players
    player_props = [
        # San Antonio Spurs Players
        {
            ...
            "opp_position_def_rating": 108.0,  # Knicks defend centers well
            "injury_boost": "green",
            "blowout_risk": "yellow",
            "role": "starter",
            "open_prop_line": 24.0,
        ...
        },
        {
            ...
            "game_pace": avg_pace,
            "opp_def_rating": 110.5,
            "opp_position_def_rating": 112.0,  # Knicks rebounding is average
            "injury_boost": "green",
            "blowout_risk": "yellow",
            "role": "starter",
            "open_prop_line": 10.0,
        ...
        },
        {
            ...
            "game_pace": avg_pace,
            "opp_def_rating": 110.5,
            "opp_position_def_rating": 109.0,  # Knicks defend guards average
            "injury_boost": "yellow",  # Minor injury concern
            "blowout_risk": "yellow",
            "role": "starter",
            "open_prop_line": 18.0,
        ...
        # New York Knicks Players
        {
            ...
            "usage_rate": 32.0,
            "game_pace": avg_pace,
            "opp_def_rating": 115.2,  # Spurs weak defense
            "opp_position_def_rating": 118.0,  # Spurs struggle vs guards
            "injury_boost": "green",
            "blowout_risk": "green",
            "role": "starter",
            "open_prop_line": 27.0,
            "current_prop_line": 27.5,
        },
        {
            "player_name": "Jalen Brunson",
            "team": "New York Knicks",
        ...
        },
        {
            ...
            "game_pace": avg_pace,
            "opp_def_rating": 115.2,
            "opp_position_def_rating": 110.0,  # Wembanyama protects rim
            "injury_boost": "green",
            "blowout_risk": "green",
            "role": "starter",
            "open_prop_line": 22.0,
            "current_prop_line": 22.5,
        },
        {
            "player_name": "Karl-Anthony Towns",
            "team": "New York Knicks",
            ...
            "game_pace": avg_pace,
            "opp_def_rating": 115.2,
            "opp_position_def_rating": 108.0,  # Wembanyama is elite rebounder
            "injury_boost": "green",
            "blowout_risk": "green",
            "role": "starter",
            "open_prop_line": 9.5,
        ...
        },
        {
            ...
            "game_pace": avg_pace,
            "opp_def_rating": 115.2,
            "opp_position_def_rating": 116.0,  # Spurs weak vs guards
            "injury_boost": "green",
            "blowout_risk": "green",
            "role": "starter",
            "open_prop_line": 2.5,
    ...
    props_results = []
    print(f"{'Player':<30} {'Prop':<20} {'Line':>6} {'Proj':>6} {'Edge':>6} {'Lean':<20}")
    print("-" * 100)
    ...
    for prop in player_props:
        ...
        print(f"{prop['player_name']:<30} {prop['prop_type']:<20} {prop['prop_line']:>6.1f} {proj_value:>6.1f} {edge:>+6.2f} {lean:<20}")
    ...
    # Save results
    output_path = Path("output/spurs_vs_knicks_analysis.json")
