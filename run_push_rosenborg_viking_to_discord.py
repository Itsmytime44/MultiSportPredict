#!/usr/bin/env python
"""
Runs a soccer match prediction for Rosenborg vs Viking and pushes it to Discord.
...
Usage:
    python run_push_rosenborg_viking_to_discord.py          # run + push
    python run_push_rosenborg_viking_to_discord.py --dry-run # print payload only
"""
...
HOME_TEAM = "Rosenborg"
AWAY_TEAM = "Viking"
LEAGUE = "Eliteserien"  # Norwegian top-flight league
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Soccer prediction for Rosenborg vs Viking")
