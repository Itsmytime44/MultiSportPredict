#!/usr/bin/env python
"""
World Cup Group Stage Analysis — Switzerland vs Bosnia-Herzegovina
Date: June 18, 2026
Using real 2026 World Cup squad data
"""
...
def main():
    ...
    print(f"\n=== WORLD CUP GROUP STAGE: {home_team} vs {away_team} ===\n")
    print("Using real 2026 World Cup squad data\n")

    # Run with real opponent context from provided roster
    ...
    print("\n=== MATCH CONTEXT ===")
    print(f"Bosnia-Herzegovina World Cup Group B record:")
    print(f"  Matches: 1")
    print(f"  Result: Draw 1-1 vs Canada (June 12, 2026)")
    print(f"  Goals For: 1 | Goals Against: 1")
    print(f"  Formation: 4-2-2-2")
    print(f"  Squad used: 26.2 players, 11 starters, 90 minutes")
    print(f"  Shots: 8 | SoT: 3 | SoT%: 37.5%")
    print(f"  Corners For: 10 | Corners Against: 24")
    print()
    print(f"Switzerland World Cup Group B record:")
    print(f"  Matches: 1")
    print(f"  Result: Draw 1-1 (details from group standings)")
    print(f"  Goals For: 1 | Goals Against: 1")
    print(f"  Last 5 form: L, D, W, D, D")
    print()

    print("=== GAME-SPECIFIC PROP BETS ===\n")
    ...
    # Core markets
    print("--- CORE MARKETS ---")
    print(f"Over 1.5 Goals: {result['goals_analysis']['over_15_prob']:.1%}")
    ...
    print(f"Double Chance (Home or Draw): {result['predictions']['double_chance']['home_or_draw']:.1%}")
    ...
    print(f"Tactical Context: {corners['tactical_context']['home_corner_gen_style']} vs {corners['tactical_context']['away_corner_gen_style']}")
    print()
    ...
    print("4. Over 2.5 Goals — strong support")
    print("5. Draw No Bet — Home")
