#!/usr/bin/env python
"""
Comprehensive Analysis for Algerian Ligue 1
...
def analyze_soccer_match(home_team, away_team, home_data, away_data, market_data, venue, date="2026-06-06", league="Algerian Ligue 1"):
    ...
    league_avg_goals = 2.45  # Algerian Ligue 1 average
    ...
    home_corners_expected = home_data.get('avg_corners_for', 5.0)
    away_corners_expected = away_data.get('avg_corners_for', 4.5)
    
    total_corners_expected = home_corners_expected + away_corners_expected
    
    over_corners_prob = 0.52 if total_corners_expected > avg_corners_per_match else 0.48
...
def run_oran_usma_analysis():
    """Run comprehensive analysis for MC Oran vs USM Alger"""
    
    print("\n" + "=" * 80)
    print("ALGERIAN LIGUE 1: MC ORAN vs USM ALGER")
    print("Algerian Ligue 1 - June 6, 2026")
    print("=" * 80 + "\n")
    ...
    result = analyze_soccer_match(
        ...
        venue="Stade Habib Bouakeul, Oran",
        date="2026-06-06",
...
def main():
    """Run MC Oran vs USM Alger analysis"""
    
    print("=" * 80)
    print("ALGERIAN LIGUE 1 COMPREHENSIVE ANALYSIS")
    print("June 6, 2026")
    print("=" * 80)
    
    result = run_oran_usma_analysis()
    
    # Save results
    output_dir = Path("output")
    output_dir.mkdir(parents=True, exist_ok=True)
    
    with open(output_dir / "mc_oran_vs_usma_alger_analysis.json", 'w') as f:
    ...
    print()
    print(f"Results saved to: output/mc_oran_vs_usma_alger_analysis.json")
    print()
    print("=" * 80)
