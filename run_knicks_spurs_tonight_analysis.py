#!/usr/bin/env python
"""
Comprehensive Analysis for NBA Game Tonight
...
def analyze_basketball_match(
    ...
    date="2026-06-08", league="NBA", player_props_data=None
):
...
def run_knicks_spurs_tonight_analysis():
    """Run comprehensive analysis for NY Knicks vs San Antonio Spurs - Tonight"""
    
    print("\n" + "=" * 80)
    print("NBA: NEW YORK KNICKS vs SAN ANTONIO SPURS - TONIGHT")
    print("NBA Regular Season - June 8, 2026")
    print("=" * 80 + "\n")
    ...
    player_props = [
        # San Antonio Spurs
        {
            ...
            "usage_rate": 31.0,
            "game_pace": 98,
            "opp_def_rating": 112.8,
            "opp_position_def_rating": 111.0,
            "injury_boost": "green",
            "blowout_risk": "yellow",
            "role": "starter",
            "open_prop_line": 25.0,
            "current_prop_line": 25.5,
        },
        {
            "player_name": "Victor Wembanyama",
            "team": "Spurs",
...
def main():
    """Run Knicks vs Spurs analysis for tonight"""
    
    print("=" * 80)
    print("NBA COMPREHENSIVE ANALYSIS - TONIGHT")
    print("June 8, 2026")
    print("=" * 80)
    
    result = run_knicks_spurs_tonight_analysis()
    
    # Save results
    output_dir = Path("output")
    output_dir.mkdir(parents=True, exist_ok=True)
    
    with open(output_dir / "knicks_spurs_tonight_analysis.json", 'w') as f:
    ...
    print()
    print(f"Results saved to: output/knicks_spurs_tonight_analysis.json")
    print()
    print("=" * 80)
