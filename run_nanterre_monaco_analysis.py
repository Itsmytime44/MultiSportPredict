#!/usr/bin/env python
"""
Comprehensive Analysis for Nanterre vs Monaco
- French Pro A Basketball
...
def analyze_basketball_match(
    ...
    date="2026-06-08", league="French Pro A", player_props_data=None
):
    ...
    league_avg_fg_pct = 0.455  # French Pro A average
...
def run_nanterre_monaco_analysis():
    """Run comprehensive analysis for Nanterre vs Monaco"""
    
    print("\n" + "=" * 80)
    print("FRENCH PRO A BASKETBALL")
    print("Nanterre vs Monaco")
    print("June 8, 2026 - Palais des Sports Maurice Thorez, Nanterre")
    print("=" * 80 + "\n")
    ...
    home_data = {
        ...
        'back_to_back': False,
        'three_in_six': False,
        'split_edge': 2.5,  # Moderate home court advantage
        'rotation_depth': 9,
        'injury_status': 'green',
    ...
    # Monaco (Away) - Strong team, playoff contender
    away_data = {
        'ortg': 114.2,
        'drtg': 107.5,
        'baseline_net': 6.7,
        ...
        'pace': 73.5,
        'rest_days': 3,
        'travel_km': 950,  # Monaco to Nanterre
        'back_to_back': False,
        'three_in_six': False,
        'split_edge': 3.5,  # Good road team
        'rotation_depth': 10,
        'injury_status': 'green',
        'coach_stability': 'green',
        'motivation': 'green',
    ...
    market_data = {
        'open_line': 4.5,
        'current_line': 5.0,
        'spread': 5.0,  # Monaco favored by 5
        'total': 162.5,
        'q1_spread': 1.5,
        'h1_spread': 2.5,
    }
    ...
    player_props = [
        # Nanterre
        {
            "player_name": "Mouhammadou Jaiteh",
            "team": "Nanterre",
            "opponent": "Monaco",
            "prop_type": "Points",
            "prop_line": 15.5,
...
def main():
    """Run Nanterre vs Monaco analysis"""
    
    print("=" * 80)
    print("FRENCH PRO A BASKETBALL - COMPREHENSIVE ANALYSIS")
    print("Nanterre vs Monaco - June 8, 2026")
    print("=" * 80)
    
    result = run_nanterre_monaco_analysis()
    
    # Save results
    output_dir = Path("output")
    output_dir.mkdir(parents=True, exist_ok=True)
    
    with open(output_dir / "nanterre_vs_monaco_analysis.json", 'w') as f:
    ...
    print()
    print(f"Results saved to: output/nanterre_vs_monaco_analysis.json")
    print()
    print("=" * 80)
