...
- Baskonia Vitoria vs DKU Joventut
...
def analyze_basketball_match(
    ...
    date="2026-06-07", league="Spain_ACB"
):
...
def run_baskonia_joventut_analysis():
    """Run analysis for Baskonia Vitoria vs DKU Joventut"""
    
    print("\n" + "=" * 80)
    print("SPANISH ACB: BASKONIA VITORIA vs DKU JOVENTUT")
    print("June 7, 2026")
    print("=" * 80 + "\n")
...
if __name__ == "__main__":
    result = run_baskonia_joventut_analysis()
    
    # Save results
    output_dir = Path("output/basketball")
    output_dir.mkdir(parents=True, exist_ok=True)
    
    with open(output_dir / "baskonia_vs_joventut_analysis.json", 'w') as f:
        json.dump(result, f, indent=2)
    
    print(f"\nDetailed results saved to: {output_dir / 'baskonia_vs_joventut_analysis.json'}")