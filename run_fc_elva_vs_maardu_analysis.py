#!/usr/bin/env python
"""
Deep Dive Analysis for Estonian Football Match
- FC Elva vs Maardu Linnameeksond
...
def deep_dive_analysis(
    ...
    date="2026-06-11", league="Estonia_Esiliiga"
):
...
def run_fc_elva_vs_maardu_linnameeksond():
    """Run deep dive analysis for FC Elva vs Maardu Linnameeksond"""
    
    print("\n" + "=" * 80)
    print("ESTONIAN ESILIIGA: FC ELVA vs MAARDU LINNAMEESKOND")
    print("Estonia Esiliiga - June 11, 2026")
    print("=" * 80 + "\n")
    ...
    result = deep_dive_analysis(
        home_team="FC Elva",
        away_team="Maardu Linnameeksond",
        home_data=home_data,
        away_data=away_data,
        market_data=market_data,
        venue="Elva linnastaadion, Elva",
        date="2026-06-11",
...
def main():
    ...
    print("=" * 80)
    print("FC ELVA vs MAARDU LINNAMEESKOND - DEEP DIVE ANALYSIS")
    print("June 11, 2026")
    print("=" * 80)
    
    # Run analysis
    result = run_fc_elva_vs_maardu_linnameeksond()
    
    # Save results
    output_dir = Path("output")
    output_dir.mkdir(parents=True, exist_ok=True)
    
    with open(output_dir / "fc_elva_vs_maardu_linnameeksond_analysis.json", 'w') as f:
    ...
    print("=" * 80)
    print()
    print(f"FC Elva vs Maardu Linnameeksond:")
    ...
    print(f"  - output/fc_elva_vs_maardu_linnameeksond_analysis.json")
    print()
    print("=" * 80)
