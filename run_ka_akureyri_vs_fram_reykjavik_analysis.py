#!/usr/bin/env python
"""
Deep Dive Analysis — Icelandic Besta deild karla
...
def run_analysis():
    print("\n" + "=" * 80)
    print("ICELANDIC BESTA DEILD KARLA")
    print("KA Akureyri vs Fram Reykjavik")
    print("=" * 80 + "\n")

    # KA Akureyri (Home) — from Akureyri (north Iceland)
    # Strong home form, physical style, mid-table side
    home_data = {
        'xg_for': 1.45,
        'xg_against': 1.35,
        'shots': 11.5,
    ...
    # Fram Reykjavik (Away) — Reykjavik club
    # Typically lower-table, struggles on the road
    away_data = {
        'xg_for': 1.20,
        'xg_against': 1.50,
        'shots': 10.0,
    ...
    home_team = "KA Akureyri"
    away_team = "Fram Reykjavik"
    league = "Iceland_Besta_deild"
    date_str = "2026-06"
    ...
    print(f"   League: Icelandic Besta deild karla")
    print()
    ...
    results = {
        "game_info": {
            "home_team": home_team,
            "away_team": away_team,
            "league": "Icelandic Besta deild karla",
            "date": date_str,
        },
        "projections": {
...
def main():
    print("=" * 80)
    print("ICELANDIC BESTA DEILD KARLA — KA Akureyri vs Fram Reykjavik")
    print("=" * 80)
    result = run_analysis()
    output_dir = Path("output")
    output_dir.mkdir(parents=True, exist_ok=True)
    output_path = output_dir / "ka_akureyri_vs_fram_reykjavik_analysis.json"
